var Anchor = {
    init: function() {
        ...
        var toggleTitle = function () {
            $('#firstname').toggleClass('  highlighted  unhighlighted');
            $('#lastname'). toggleClass('unhighlighted   highlighted');
        }
        $('#firstname').mouseenter(toggleTitle);
        $('#lastname').mouseenter(toggleTitle);
    },
